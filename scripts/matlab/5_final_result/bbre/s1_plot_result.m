...
% Load parameters
core = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/bbre/core_parameters.csv");
shell = readtable("/media/microlab/hdd/taproschle/model/4_shell_fit/bbre/shell_parameters.csv");
