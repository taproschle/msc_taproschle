...
% Load parameters
core = readtable("../../3_core_fit/lsym/core_parameters.csv");
shell = readtable("../../4_shell_fit/lsym/shell_parameters.csv");
...
for i = 1:height(core)
    for j = 1:20
        load("../../3_core_fit/lsym/results/ess_report_" + num2str(j) + ".mat", 'Results')
...
for i = 1:height(shell)
    for j = 1:10
        load("../../4_shell_fit/lsym/results/ess_report_" + num2str(j) + ".mat", 'Results')
