...
% Load parameters
core = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/lsym/core_parameters.csv");
shell = readtable("/media/microlab/hdd/taproschle/model/4_shell_fit/lsym/shell_parameters.csv");

parameters = sortrows([core ; shell], 'index');
