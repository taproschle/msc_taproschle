...
% Load parameters
core = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/binf/core_parameters.csv");
shell = readtable("/media/microlab/hdd/taproschle/model/4_shell_fit/binf/shell_parameters.csv");
