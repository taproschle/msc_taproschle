...
% Load parameters
core = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/all/core_parameters.csv");
shell = readtable("/media/microlab/hdd/taproschle/model/4_shell_fit/all/shell_parameters.csv");
