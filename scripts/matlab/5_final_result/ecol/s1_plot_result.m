...
% Load parameters
core = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/ecol/core_parameters.csv");
shell = readtable("/media/microlab/hdd/taproschle/model/4_shell_fit/ecol/shell_parameters.csv");
