...
pfix = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/bbif/core_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/bbif/shell_parameters.csv");
...
data = data(data.experiment == "bbif", :);
