function dsdt = model(~, s, params, pfix)
    ...
    Y_XCom_S2FL       = params(1);
    Y_XCom_S3SL       = params(2);
    Y_XCom_SLactose   = params(3);
    Y_XCom_SGalactose = pfix.value(4);
    Y_XCom_SGlucose   = pfix.value(5);
    Y_XCom_SNeu5Ac    = params(4);
    Y_XCom_SFucose    = params(5);
    ...
    K_S3SL       = params(8);
    K_SLactose   = params(9);
    K_SGalactose = params(10);
    K_SGlucose   = params(11);
    K_SNeu5Ac    = params(12);
    K_SFucose    = params(13);
