...
pfix = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/bthe/core_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/bthe/shell_parameters.csv");
