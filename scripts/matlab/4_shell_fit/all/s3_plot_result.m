...
pfix = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/all/core_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/all/shell_parameters.csv");
