function dsdt = model(~, s, params, pfix)
    ...
    Y_XCom_SLNT       = pfix.value(3);
    Y_XCom_S2FL       = pfix.value(4);
    Y_XCom_S3SL       = params(1);
    Y_XCom_SLactose   = pfix.value(5);
    Y_XCom_SGalactose = pfix.value(6);
    Y_XCom_SGlucose   = pfix.value(7);
    Y_XCom_SNeu5Ac    = params(2);
    Y_XCom_SFucose    = params(3);
    ...
    K_S3SL       = params(7);
    K_SLactose   = params(8);
    K_SGalactose = params(9);
    K_SGlucose   = params(10);
    K_SNeu5Ac    = params(11);
    K_SFucose    = params(12);
