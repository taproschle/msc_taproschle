...
pfix = readtable("/media/microlab/hdd/taproschle/model/3_core_fit/lsym/core_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/lsym/shell_parameters.csv");
...
data = data(data.experiment == "lsym", :);
