...
pfix = readtable("/media/microlab/hdd/taproschle/model/2_fia/lsym/shell_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/lsym/core_parameters.csv");
