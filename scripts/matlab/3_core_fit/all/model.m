function dsdt = model(~, s, params, pfix)
    ...
    Y_XCom_S3SL       = pfix.value(1);
    Y_XCom_SLactose   = params(5);
    Y_XCom_SGalactose = params(6);
    Y_XCom_SGlucose   = params(7);
    Y_XCom_SNeu5Ac    = pfix.value(2);
    Y_XCom_SFucose    = pfix.value(3);
