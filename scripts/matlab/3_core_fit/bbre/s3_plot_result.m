...
pfix = readtable("/media/microlab/hdd/taproschle/model/2_fia/bbre/shell_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/bbre/core_parameters.csv");
