...
pfix = readtable("/media/microlab/hdd/taproschle/model/2_fia/paci/shell_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/paci/core_parameters.csv");
