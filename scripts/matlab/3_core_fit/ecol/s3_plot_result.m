...
pfix = readtable("/media/microlab/hdd/taproschle/model/2_fia/ecol/shell_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/ecol/core_parameters.csv");
...
data = data(data.experiment == "ecol", :);
