...
pfix = readtable("/media/microlab/hdd/taproschle/model/2_fia/binf/shell_parameters.csv");
padj = readtable("/media/microlab/hdd/taproschle/model/2_fia/binf/core_parameters.csv");
